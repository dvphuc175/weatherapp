 ...
 * of being limited to the last city fetched. Air quality is stored alongside the weather snapshot
 * when available; it does not affect whether the core weather/forecast cache is usable.
 */
